...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Ge0metr1', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://ge0metr1.xyz', // 网站地址
  ...
  GREETING_WORDS:
    ...
    '111Hi，我是一个程序员, Hi，我是一个打工人,Hi，我是一个干饭人,欢迎来到我的博客🎉',
